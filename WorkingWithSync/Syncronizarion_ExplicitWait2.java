...
public class Syncronizarion_ExplicitWait2 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement enableBox1_Button = driver.findElement(By.xpath("//button[@onclick='enableInput(2, 10000)']"));
		enableBox1_Button.click();
		// used to find or locate the web element like enable box 1

		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(15));
		WebElement textBox2 = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@type='text' and @id='target-2']")));
